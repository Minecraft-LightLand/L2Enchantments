...
import dev.xkmc.playerdifficulty.content.enchantments.core.TickingEnchantment;
...
public class LifeSync extends ToolEnchant implements TickingEnchantment {
	...
	public static final Supplier<Double> VALUE = DifficultyConfig.COMMON.lifeSync::get;
